...
<body class="w3-light-grey">
    ...
    <div class="w3-main" style="margin-left:<%= String.IsNullOrEmpty(IframeEdit) ? "300px" : "10px" %>;margin-top:60px; " id="base-panel">
        ...
        <div id="simplisity_startpanel" class="simplisity_panel" s-cmd="rocketmod_selectapptheme" s-track="true" s-fields="tabid:<%= String.IsNullOrEmpty(TabId) ? "" : TabId %>,moduleid:<%= String.IsNullOrEmpty(ModuleId) ? "" : ModuleId %>,theme:config-w3,template:products.cshtml,interfacekey:edit"></div>
