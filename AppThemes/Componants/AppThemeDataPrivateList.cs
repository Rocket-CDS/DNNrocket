            ...
            if (SelectedSystemKey != "")
            {
                ...
                if (ftpConnect.IsValid)
                {
                    ...
                    foreach (SimplisityRecord a in SortedList)
                    {
                        ...
                        var onlineIndex = (OnlineAppThemeIndex)CacheUtilsDNN.GetCache(appTheme.SystemKey + "_privateIndex");
                        if (onlineIndex == null)
                        {
                            onlineIndex = new OnlineAppThemeIndex(appTheme.SystemKey,"private");
                            CacheUtilsDNN.SetCache(appTheme.SystemKey + "_privateIndex", onlineIndex);
                        }
