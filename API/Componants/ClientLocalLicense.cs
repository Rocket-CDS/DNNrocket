...
namespace RocketLicense.Componants
{
    public class ClientLocalLicense
    {
        ...
        public ClientLocalLicense(int licenseId)
        {
            _guidkey = "";
            _licenseId = licenseId;
            LoadData();
        }
        public ClientLocalLicense(string systemkey, string sitekey )
        {
        ...
        public void ImportRecord(string xmlImport)
        {
